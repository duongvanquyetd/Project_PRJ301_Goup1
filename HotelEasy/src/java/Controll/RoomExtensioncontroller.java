...
//
//for (RoomImageDTO x : listImgRoom) {
//    if (x.getHotelID().equalsIgnoreCase(htId) && x.getRoomID().equalsIgnoreCase(roomiD)) {  
//        img = x.getImage();  
//        break; // Dừng vòng lặp ngay khi tìm thấy ảnh của phòng cần tìm
//    }
//}
    ...
    request.setAttribute("RoomImg", listImgRoom);
