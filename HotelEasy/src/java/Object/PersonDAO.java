    ...
    public List<PersonDTO> getAllPerson() {
        try {
            ...
            while (rs.next()) {
                ...
                list.add(new PersonDTO(rs.getString("PersonID").trim(), rs.getString("Password").trim(), rs.getString("Name").trim(), rs.getString("Gender").trim(), rs.getString("Phone").trim(), rs.getString("RoleID").trim()));
            }
            return list;
        } catch (Exception e) {
        }
