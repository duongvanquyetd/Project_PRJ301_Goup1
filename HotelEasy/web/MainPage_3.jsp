...
<html lang="en">
    ...
    <body>
        ...
        <div class="Main_page">
            <%
                List<HotelDTA> h = (List<HotelDTA>) request.getAttribute("Roomm");
            ...
            <div class="card">
                <div class="card-img-container">
                    <% for (HotelDTA d : h) {%>
                    <img style="border-radius: 10px;" src="image/hotel/KhachSanPageMain/DaNang.png" class="card-img-top" alt="Hotel">
                    <i class="fa-solid fa-heart favorite-icon"></i>
                </div>
                <div class="card-body">
                    <h5>Thành Phố <%=d.getCity()%></h5>
                    <p class="price">
                        <strong><%= d.getRoomCount()%></strong>
                    </p>
                    <% }%>
                </div>
           </div>
