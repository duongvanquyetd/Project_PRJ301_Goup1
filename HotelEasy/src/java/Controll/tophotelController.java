 ...
 * @author pvand
 */
@WebServlet(name = "tophotelController", urlPatterns = {"/tophotelController"})
public class tophotelController extends HttpServlet {
